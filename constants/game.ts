...
export const CHALLENGE_LEVELS: ChallengeLevel[] = [
  ...
  },
  {
    id: 2,
    name: 'Speed Demon',
    description: 'Stack 10 blocks in 15 seconds',
    objective: 'Stack 10 blocks within 15 seconds',
    targetBlocks: 10,
    timeLimit: 15,
    completed: false,
    stars: 0,
  ...
  },
  {
    ...
    objective: 'Stack 12 blocks in 15 seconds',
    targetBlocks: 12,
    timeLimit: 15,
    completed: false,
    stars: 0,
  ...
  },
  {
    ...
    objective: 'Stack 20 blocks in 20 seconds',
    targetBlocks: 20,
    timeLimit: 20,
    completed: false,
    stars: 0,
  ...
  },
  {
    ...
    objective: 'Stack 15 slippery blocks in 16 seconds',
    targetBlocks: 15,
    timeLimit: 16,
    specialBlocks: ['slippery'],
    completed: false,
  ...
  },
  {
    ...
    objective: 'Stack 15 blocks perfectly in 30 seconds',
    targetBlocks: 15,
    timeLimit: 30,
  ...
  },
  {
    ...
    objective: 'Stack 30 blocks in 30 seconds',
    targetBlocks: 30,
    timeLimit: 30,
    completed: false,
    stars: 0,
...
export const THEMES: Theme[] = [
  {
    id: 'default',
    name: 'Classic',
    backgroundColors: ['#0a0a0a', '#1a1a1a'] as const,
    blockColors: [
      ['#FFEAA7', '#FFDD94'] as const,
      ['#FF6B6B', '#FF8E8E'] as const,
      ['#4ECDC4', '#6FE3DC'] as const,
